...
The overall \product{} test specification is defined in \citeds{LDM-536}.
...
{\textit Input data for all tests was based on the DeCAM “HiTS” dataset, as described in \citeds{LDM-533}.}
